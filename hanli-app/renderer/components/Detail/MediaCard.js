    ...
    async copyFilesToFolder(items, targetPath) {
        try {
            ...
            if (result.success) {
                console.log('文件复制成功');
                if (window.showToast) {
                    window.showToast(`已复制 ${items.length} 个文件到目标文件夹`, 'success');
                } else {
                ...
                if (window.showToast) {
                    window.showToast('文件复制失败: ' + result.error, 'error');
                } else {
            ...
            if (window.showToast) {
                window.showToast('复制文件失败: ' + error.message, 'error');
            } else {
    ...
    async moveToTrash(index, fileName, filePath) {
        try {
            ...
            if (result.success) {
                ...
                // 显示成功提示
                if (window.showToast) {
                    window.showToast('文件已移动到废纸篓', 'success');
                } else {
                    alert('文件已移动到废纸篓');
                }
            } else {
